...
**`#include <qb/linq.h>`** · namespace **`qb::linq`** · target **`qb::linq`** · [Versioning](docs/VERSIONING.md)

[Features](#why-qb-linq) · [Quick start](#quick-start-cmake) · [**Full API**](#complete-api-reference) · [Examples](#examples) · [Build & test](#build-options-this-repository) · [Performance](#performance--benchmarks) · [Docs hub](docs/README.md) · [Contributing](CONTRIBUTING.md) · [Changelog](CHANGELOG.md) · [AI assistants](#ai-assistants--agentic-workflows)
...
**Version macros** (`QB_LINQ_VERSION_STRING`, `qb::linq::version`, …) come from **`qb/linq/version.h`**, generated by CMake — see **[`docs/VERSIONING.md`](docs/VERSIONING.md)**.
...
- **Scripts:** `python scripts/amalgamate_single_header.py` or `pwsh -File scripts/amalgamate_single_header.ps1` (repo root)
...
**Full detail** (presets, install, FetchContent versions, flags): **[`docs/BUILDING.md`](docs/BUILDING.md)**.
...
- **[`AGENTS.md`](AGENTS.md)** — checklist for coding agents (file map, verification, pointers to build + implementation docs).
- **[`docs/BUILDING.md`](docs/BUILDING.md)** — CMake targets, options, presets (same facts as `CMakeLists.txt`).
- **[`docs/LLM_CONTEXT.md`](docs/LLM_CONTEXT.md)** — dense implementation reference for LLMs.
- **Cursor:** [`.cursor/rules/`](.cursor/rules/) · skill [`.cursor/skills/qb-linq-development/`](.cursor/skills/qb-linq-development/)

## Documentation

- **Docs hub (index):** [`docs/README.md`](docs/README.md)
...
- **Build / install:** [`docs/BUILDING.md`](docs/BUILDING.md)
- **Versioning (SemVer, macros, CMake):** [`docs/VERSIONING.md`](docs/VERSIONING.md)
- **LLM / agent (architecture, file map):** [`docs/LLM_CONTEXT.md`](docs/LLM_CONTEXT.md)
- **Changelog:** [`CHANGELOG.md`](CHANGELOG.md)
- **Contributing:** [`CONTRIBUTING.md`](CONTRIBUTING.md)
- **Code of Conduct:** [`CODE_OF_CONDUCT.md`](CODE_OF_CONDUCT.md)
- **Security:** [`SECURITY.md`](SECURITY.md)
- **HTML (Doxygen):** `QB_LINQ_BUILD_DOCS=ON` → target **`qb_linq_docs`** (output under the build tree, see [`docs/BUILDING.md`](docs/BUILDING.md))
...
See **[`CONTRIBUTING.md`](CONTRIBUTING.md)** and **[`CODE_OF_CONDUCT.md`](CODE_OF_CONDUCT.md)** for expectations. Short version: behaviour changes need **tests** in `tests/`; keep **benchmark** builds green when you touch hot paths. Build help: **[`docs/BUILDING.md`](docs/BUILDING.md)**. Agents: **[`AGENTS.md`](AGENTS.md)**, **[`docs/LLM_CONTEXT.md`](docs/LLM_CONTEXT.md)**.
